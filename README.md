...
End-to-end sales analysis using PostgreSQL, Power BI &amp; Streamlit — CTEs, Window Functions, customer segmentation &amp; YoY trends on Classic Models dataset.
...
if section == "🏠 Overview":
    ...
    with col1:
        img = load_img(r"D:\shivang sharma\shiv ds\project\charts\1.png")
        if img:
            st.image(img, use_container_width=True, caption="Raw dataset — Classic Models Sales DB")
    with col2:
        img2 = load_img(r"D:\shivang sharma\shiv ds\project\charts\1.png")
        if img2:
